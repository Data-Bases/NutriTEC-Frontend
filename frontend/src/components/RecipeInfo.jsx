...
function RecipeInfo({ receta, setRecipes}) {
    ...
    return (
        <div>
            ...
            {(receta != null) ?
                <>
                    {isInfoEditable ?
                        <RecipeEditableInfo receta={receta} isInfoEditableFunction={handleIsInfoEditable} setRecipes={setRecipes}></RecipeEditableInfo>
                        :
                        <>
